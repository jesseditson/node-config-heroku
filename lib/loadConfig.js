...
var overloadConfig = function(name,filePath){
  if(fs.existsSync(filePath)){
    try {
      ...
      this._extendDeep(this.config,loadedConfig)
      return true
    } catch(e){
...
var init = function(){
  ...
  return overloadConfig.call(this,'runtime',path.join(CONFIG_DIR,runtimeJsonFilename))
}
